...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.recomendations'
        db.add_column('attestation_request', 'recomendations',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Request.decision'
        db.add_column('attestation_request', 'decision',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Request.notes'
        db.add_column('attestation_request', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.recomendations'
        db.delete_column('attestation_request', 'recomendations')

        # Deleting field 'Request.decision'
        db.delete_column('attestation_request', 'decision')

        # Deleting field 'Request.notes'
        db.delete_column('attestation_request', 'notes')
