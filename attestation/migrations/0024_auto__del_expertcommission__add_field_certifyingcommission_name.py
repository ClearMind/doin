...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CertifyingCommission.name'
        db.add_column('attestation_certifyingcommission', 'name',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CertifyingCommission.name'
        db.delete_column('attestation_certifyingcommission', 'name')
