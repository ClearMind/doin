...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Qualification.for_confirmation'
        db.delete_column('attestation_qualification', 'for_confirmation')


        # Renaming column for 'Expert.organization' to match new field type.
        db.rename_column('attestation_expert', 'organization_id', 'organization')
        # Changing field 'Expert.organization'
        db.alter_column('attestation_expert', 'organization', self.gf('django.db.models.fields.CharField')(max_length=128))
        # Removing index on 'Expert', fields ['organization']
        db.delete_index('attestation_expert', ['organization_id'])


    def backwards(self, orm):
        # Adding index on 'Expert', fields ['organization']
        db.create_index('attestation_expert', ['organization_id'])

        # Adding field 'Qualification.for_confirmation'
        db.add_column('attestation_qualification', 'for_confirmation',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Renaming column for 'Expert.organization' to match new field type.
        db.rename_column('attestation_expert', 'organization', 'organization_id')
        # Changing field 'Expert.organization'
        db.alter_column('attestation_expert', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attestation.Organization']))
