...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Education.institution'
        db.alter_column('attestation_education', 'institution', self.gf('django.db.models.fields.CharField')(max_length=512))
        # Adding field 'Request.discipline'
        db.add_column('attestation_request', 'discipline',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Request.organization_name'
        db.alter_column('attestation_request', 'organization_name', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

    def backwards(self, orm):

        # Changing field 'Education.institution'
        db.alter_column('attestation_education', 'institution', self.gf('django.db.models.fields.CharField')(max_length=128))
        # Deleting field 'Request.discipline'
        db.delete_column('attestation_request', 'discipline')


        # Changing field 'Request.organization_name'
        db.alter_column('attestation_request', 'organization_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
