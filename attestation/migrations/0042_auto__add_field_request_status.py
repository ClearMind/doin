...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('attestation_request', 'status',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attestation.RequestStatus'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.status'
        db.delete_column('attestation_request', 'status_id')
