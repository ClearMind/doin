...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Expert.not_active'
        db.add_column('attestation_expert', 'not_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Expert.not_active'
        db.delete_column('attestation_expert', 'not_active')
