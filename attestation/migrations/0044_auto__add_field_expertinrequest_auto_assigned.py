...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExpertInRequest.auto_assigned'
        db.add_column('attestation_expertinrequest', 'auto_assigned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExpertInRequest.auto_assigned'
        db.delete_column('attestation_expertinrequest', 'auto_assigned')
