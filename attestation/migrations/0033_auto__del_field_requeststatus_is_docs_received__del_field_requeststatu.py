...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RequestStatus.is_docs_received'
        db.delete_column('attestation_requeststatus', 'is_docs_received')

        # Deleting field 'RequestStatus.simple_event'
        db.delete_column('attestation_requeststatus', 'simple_event')

        # Adding field 'RequestStatus.is_expertise_results_received'
        db.add_column('attestation_requeststatus', 'is_expertise_results_received',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RequestStatus.is_fail'
        db.add_column('attestation_requeststatus', 'is_fail',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RequestStatus.is_docs_received'
        db.add_column('attestation_requeststatus', 'is_docs_received',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RequestStatus.simple_event'
        db.add_column('attestation_requeststatus', 'simple_event',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'RequestStatus.is_expertise_results_received'
        db.delete_column('attestation_requeststatus', 'is_expertise_results_received')

        # Deleting field 'RequestStatus.is_fail'
        db.delete_column('attestation_requeststatus', 'is_fail')
