...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('attestation_comment', (
        ...
        db.send_create_signal('attestation', ['Comment'])


        # Changing field 'RequestFlow.date'
        db.alter_column('attestation_requestflow', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Education.speciality'
        db.alter_column('attestation_education', 'speciality', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Education.qualification'
        db.alter_column('attestation_education', 'qualification', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):
        # Deleting model 'Comment'
        db.delete_table('attestation_comment')


        # Changing field 'RequestFlow.date'
        db.alter_column('attestation_requestflow', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'Education.speciality'
        db.alter_column('attestation_education', 'speciality', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Education.qualification'
        db.alter_column('attestation_education', 'qualification', self.gf('django.db.models.fields.CharField')(max_length=50))
