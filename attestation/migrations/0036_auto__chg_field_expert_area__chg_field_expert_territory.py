...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Expert.area'
        db.alter_column('attestation_expert', 'area_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['attestation.Area']))

        # Changing field 'Expert.territory'
        db.alter_column('attestation_expert', 'territory_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['attestation.Territory']))

    def backwards(self, orm):

        # Changing field 'Expert.area'
        db.alter_column('attestation_expert', 'area_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attestation.Area'], null=True))

        # Changing field 'Expert.territory'
        db.alter_column('attestation_expert', 'territory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attestation.Territory'], null=True))
