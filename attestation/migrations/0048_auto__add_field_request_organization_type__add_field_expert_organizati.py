...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.organization_type'
        db.add_column('attestation_request', 'organization_type',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Expert.organization_type'
        db.add_column('attestation_expert', 'organization_type',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.organization_type'
        db.delete_column('attestation_request', 'organization_type')

        # Deleting field 'Expert.organization_type'
        db.delete_column('attestation_expert', 'organization_type')
    ...
    models = {
        ...
        'attestation.expert': {
            ...
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'middle_name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'not_active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'organization': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'organization_type': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
        ...
        'attestation.expertinrequest': {
            ...
            'auto_assigned': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'attestation.request': {
            ...
            'doc_date': ('django.db.models.fields.DateField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'doc_for_simple': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '256', 'null': 'True', 'blank': 'True'}),
            ...
            'official_email': ('django.db.models.fields.EmailField', [], {'default': 'None', 'max_length': '75', 'null': 'True', 'blank': 'True'}),
            ...
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['attestation.RequestStatus']", 'null': 'True', 'blank': 'True'}),
            'territory': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['attestation.Territory']", 'null': 'True', 'blank': 'True'}),
