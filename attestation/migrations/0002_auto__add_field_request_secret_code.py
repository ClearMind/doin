...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.secret_code'
        db.add_column('attestation_request', 'secret_code',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.secret_code'
        db.delete_column('attestation_request', 'secret_code')
