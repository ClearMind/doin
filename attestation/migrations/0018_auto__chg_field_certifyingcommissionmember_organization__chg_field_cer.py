...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'CertifyingCommissionMember.organization' to match new field type.
        db.rename_column('attestation_certifyingcommissionmember', 'organization_id', 'organization')
        # Changing field 'CertifyingCommissionMember.organization'
        db.alter_column('attestation_certifyingcommissionmember', 'organization', self.gf('django.db.models.fields.CharField')(max_length=512))
        # Removing index on 'CertifyingCommissionMember', fields ['organization']
        db.delete_index('attestation_certifyingcommissionmember', ['organization_id'])


        # Renaming column for 'CertifyingCommissionMember.post' to match new field type.
        db.rename_column('attestation_certifyingcommissionmember', 'post_id', 'post')
        # Changing field 'CertifyingCommissionMember.post'
        db.alter_column('attestation_certifyingcommissionmember', 'post', self.gf('django.db.models.fields.CharField')(max_length=128))
        # Removing index on 'CertifyingCommissionMember', fields ['post']
        db.delete_index('attestation_certifyingcommissionmember', ['post_id'])


    def backwards(self, orm):
        # Adding index on 'CertifyingCommissionMember', fields ['post']
        db.create_index('attestation_certifyingcommissionmember', ['post_id'])

        # Adding index on 'CertifyingCommissionMember', fields ['organization']
        db.create_index('attestation_certifyingcommissionmember', ['organization_id'])


        # Renaming column for 'CertifyingCommissionMember.organization' to match new field type.
        db.rename_column('attestation_certifyingcommissionmember', 'organization', 'organization_id')
        # Changing field 'CertifyingCommissionMember.organization'
        db.alter_column('attestation_certifyingcommissionmember', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attestation.Organization']))

        # Renaming column for 'CertifyingCommissionMember.post' to match new field type.
        db.rename_column('attestation_certifyingcommissionmember', 'post', 'post_id')
        # Changing field 'CertifyingCommissionMember.post'
        db.alter_column('attestation_certifyingcommissionmember', 'post_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attestation.Post']))
