...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('attestation_criterion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.TextField')(unique=True)),
        ))
        db.send_create_signal('attestation', ['Criterion'])

        # Adding model 'Indicator'
        db.create_table('attestation_indicator', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.TextField')(unique=True)),
            ('cost', self.gf('django.db.models.fields.IntegerField')(default=10)),
            ('criterion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attestation.Criterion'])),
        ))
        db.send_create_signal('attestation', ['Indicator'])

        # Adding unique constraint on 'ExpertInRequest', fields ['request', 'expert']
        db.create_unique('attestation_expertinrequest', ['request_id', 'expert_id'])

        # Adding field 'Config.category'
        db.add_column('attestation_config', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['attestation.Qualification']),
                      keep_default=False)

        # Adding field 'CertifyingCommissionMember.territory'
        db.add_column('attestation_certifyingcommissionmember', 'territory',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attestation.Territory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'ExpertInRequest', fields ['request', 'expert']
        db.delete_unique('attestation_expertinrequest', ['request_id', 'expert_id'])

        # Deleting model 'Criterion'
        db.delete_table('attestation_criterion')

        # Deleting model 'Indicator'
        db.delete_table('attestation_indicator')

        # Deleting field 'Config.category'
        db.delete_column('attestation_config', 'category_id')

        # Deleting field 'CertifyingCommissionMember.territory'
        db.delete_column('attestation_certifyingcommissionmember', 'territory_id')
