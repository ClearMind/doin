...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Request.doc_for_simple'
        db.alter_column('attestation_request', 'doc_for_simple', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

    def backwards(self, orm):

        # Changing field 'Request.doc_for_simple'
        db.alter_column('attestation_request', 'doc_for_simple', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
    ...
    models = {
        ...
        'attestation.request': {
            ...
            'doc_for_simple': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '512', 'null': 'True', 'blank': 'True'}),
