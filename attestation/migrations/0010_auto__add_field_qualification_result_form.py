...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Qualification.result_form'
        db.add_column('attestation_qualification', 'result_form',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Qualification.result_form'
        db.delete_column('attestation_qualification', 'result_form')
