...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Qualification.is_active'
        db.add_column('attestation_qualification', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Qualification.is_active'
        db.delete_column('attestation_qualification', 'is_active')
