...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.retrain'
        db.add_column('attestation_request', 'retrain',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Request.attestation_date'
        db.add_column('attestation_request', 'attestation_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Request.order_number'
        db.add_column('attestation_request', 'order_number',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.retrain'
        db.delete_column('attestation_request', 'retrain')

        # Deleting field 'Request.attestation_date'
        db.delete_column('attestation_request', 'attestation_date')

        # Deleting field 'Request.order_number'
        db.delete_column('attestation_request', 'order_number')
