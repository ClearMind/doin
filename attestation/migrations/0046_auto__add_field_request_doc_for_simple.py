...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.doc_for_simple'
        db.add_column('attestation_request', 'doc_for_simple',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.doc_for_simple'
        db.delete_column('attestation_request', 'doc_for_simple')
