...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Area'
        db.create_table('attestation_area', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal('attestation', ['Area'])

        # Adding field 'Expert.area'
        db.add_column('attestation_expert', 'area',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attestation.Area'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Area'
        db.delete_table('attestation_area')

        # Deleting field 'Expert.area'
        db.delete_column('attestation_expert', 'area_id')
