...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.birth_date'
        db.add_column('attestation_request', 'birth_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 11, 9, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.birth_date'
        db.delete_column('attestation_request', 'birth_date')
