...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExpertInRequest.first_grade'
        db.alter_column('attestation_expertinrequest', 'first_grade', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'ExpertInRequest.second_grade'
        db.alter_column('attestation_expertinrequest', 'second_grade', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'ExpertInRequest.first_grade'
        db.alter_column('attestation_expertinrequest', 'first_grade', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ExpertInRequest.second_grade'
        db.alter_column('attestation_expertinrequest', 'second_grade', self.gf('django.db.models.fields.IntegerField')(null=True))
