...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequestStatus.next_status'
        db.add_column('attestation_requeststatus', 'next_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attestation.RequestStatus'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RequestStatus.next_status'
        db.delete_column('attestation_requeststatus', 'next_status_id')
