...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.agree'
        db.add_column('attestation_request', 'agree',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Request.disagree'
        db.add_column('attestation_request', 'disagree',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.agree'
        db.delete_column('attestation_request', 'agree')

        # Deleting field 'Request.disagree'
        db.delete_column('attestation_request', 'disagree')
