...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Expert.territory'
        db.add_column('attestation_expert', 'territory',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attestation.Territory'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Expert.email'
        db.add_column('attestation_expert', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Expert.organization'
        db.alter_column('attestation_expert', 'organization', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):
        # Deleting field 'Expert.territory'
        db.delete_column('attestation_expert', 'territory_id')

        # Deleting field 'Expert.email'
        db.delete_column('attestation_expert', 'email')


        # User chose to not deal with backwards NULL issues for 'Expert.organization'
        raise RuntimeError("Cannot reverse this migration. 'Expert.organization' and its values cannot be restored.")
