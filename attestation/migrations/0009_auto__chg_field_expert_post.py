...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Expert.post' to match new field type.
        db.rename_column('attestation_expert', 'post_id', 'post')
        # Changing field 'Expert.post'
        db.alter_column('attestation_expert', 'post', self.gf('django.db.models.fields.CharField')(max_length=256))
        # Removing index on 'Expert', fields ['post']
        db.delete_index('attestation_expert', ['post_id'])


    def backwards(self, orm):
        # Adding index on 'Expert', fields ['post']
        db.create_index('attestation_expert', ['post_id'])


        # Renaming column for 'Expert.post' to match new field type.
        db.rename_column('attestation_expert', 'post', 'post_id')
        # Changing field 'Expert.post'
        db.alter_column('attestation_expert', 'post_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attestation.Post']))
