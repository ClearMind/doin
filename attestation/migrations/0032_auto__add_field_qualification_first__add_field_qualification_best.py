...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Qualification.first'
        db.add_column('attestation_qualification', 'first',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Qualification.best'
        db.add_column('attestation_qualification', 'best',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Qualification.first'
        db.delete_column('attestation_qualification', 'first')

        # Deleting field 'Qualification.best'
        db.delete_column('attestation_qualification', 'best')
