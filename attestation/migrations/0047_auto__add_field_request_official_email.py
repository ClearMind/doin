...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.official_email'
        db.add_column('attestation_request', 'official_email',
                      self.gf('django.db.models.fields.EmailField')(default=None, max_length=75, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Request.official_email'
        db.delete_column('attestation_request', 'official_email')
