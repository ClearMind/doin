...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.number_of_members'
        db.add_column('attestation_request', 'number_of_members',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.number_of_members'
        db.delete_column('attestation_request', 'number_of_members')
