...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Config.start_date'
        db.alter_column('attestation_config', 'start_date', self.gf('django.db.models.fields.DateField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Config.start_date'
        db.alter_column('attestation_config', 'start_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
