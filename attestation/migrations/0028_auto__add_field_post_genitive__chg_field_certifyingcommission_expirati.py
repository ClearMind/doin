...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.genitive'
        db.add_column('attestation_post', 'genitive',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=70),
                      keep_default=False)


        # Changing field 'CertifyingCommission.expiration_date'
        db.alter_column('attestation_certifyingcommission', 'expiration_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 11, 28, 0, 0)))
        # Adding field 'Request.genitive'
        db.add_column('attestation_request', 'genitive',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=96),
                      keep_default=False)

        # Adding field 'CertifyingCommissionMember.request_form'
        db.add_column('attestation_certifyingcommissionmember', 'request_form',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=96),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.genitive'
        db.delete_column('attestation_post', 'genitive')


        # Changing field 'CertifyingCommission.expiration_date'
        db.alter_column('attestation_certifyingcommission', 'expiration_date', self.gf('django.db.models.fields.DateField')(null=True))
        # Deleting field 'Request.genitive'
        db.delete_column('attestation_request', 'genitive')

        # Deleting field 'CertifyingCommissionMember.request_form'
        db.delete_column('attestation_certifyingcommissionmember', 'request_form')
