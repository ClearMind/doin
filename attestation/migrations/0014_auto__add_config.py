...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Config'
        db.create_table('attestation_config', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('end_date', self.gf('django.db.models.fields.DateField')()),
            ('first_stage_max_grade', self.gf('django.db.models.fields.IntegerField')()),
            ('second_stage_max_grade', self.gf('django.db.models.fields.IntegerField')()),
            ('first_stage_min_grade', self.gf('django.db.models.fields.IntegerField')()),
            ('second_stage_min_grade', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('attestation', ['Config'])


    def backwards(self, orm):
        # Deleting model 'Config'
        db.delete_table('attestation_config')
