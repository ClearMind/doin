...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CertifyingCommission.name'
        db.alter_column('attestation_certifyingcommission', 'name', self.gf('django.db.models.fields.CharField')(max_length=512))

    def backwards(self, orm):

        # Changing field 'CertifyingCommission.name'
        db.alter_column('attestation_certifyingcommission', 'name', self.gf('django.db.models.fields.CharField')(max_length=32))
