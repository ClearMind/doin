...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Organization.settlement'
        db.delete_column('attestation_organization', 'settlement_id')

        # Adding field 'Organization.full_name'
        db.add_column('attestation_organization', 'full_name',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.territory'
        db.add_column('attestation_organization', 'territory',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Organization.settlement'
        raise RuntimeError("Cannot reverse this migration. 'Organization.settlement' and its values cannot be restored.")
        # Deleting field 'Organization.full_name'
        db.delete_column('attestation_organization', 'full_name')

        # Deleting field 'Organization.territory'
        db.delete_column('attestation_organization', 'territory_id')
