...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Config.is_child_organization'
        db.add_column('attestation_config', 'is_child_organization',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Config.first_stage_max_grade'
        db.alter_column('attestation_config', 'first_stage_max_grade', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Config.second_stage_max_grade'
        db.alter_column('attestation_config', 'second_stage_max_grade', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Config.is_child_organization'
        db.delete_column('attestation_config', 'is_child_organization')


        # User chose to not deal with backwards NULL issues for 'Config.first_stage_max_grade'
        raise RuntimeError("Cannot reverse this migration. 'Config.first_stage_max_grade' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Config.second_stage_max_grade'
        raise RuntimeError("Cannot reverse this migration. 'Config.second_stage_max_grade' and its values cannot be restored.")
