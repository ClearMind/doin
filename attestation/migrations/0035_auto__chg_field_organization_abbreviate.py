...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Organization.abbreviate'
        db.alter_column('attestation_organization', 'abbreviate', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32))

    def backwards(self, orm):

        # Changing field 'Organization.abbreviate'
        db.alter_column('attestation_organization', 'abbreviate', self.gf('django.db.models.fields.CharField')(max_length=10, unique=True))
