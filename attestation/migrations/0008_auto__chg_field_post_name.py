...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('attestation_post', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64))

    def backwards(self, orm):

        # Changing field 'Post.name'
        db.alter_column('attestation_post', 'name', self.gf('django.db.models.fields.CharField')(max_length=32, unique=True))
